...
package com.spark.optimization.exec.QueryGroupByMin

import com.spark.optimization.exec.AbstractJob

/** QueryGroupByCount */

object QueryGroupByMinOptJob extends AbstractJob {
  ...
  override val query: String =
    """
      |Select table1.topic, min(table1.file_no) FROM enron_data as table1 join enron_data table2
