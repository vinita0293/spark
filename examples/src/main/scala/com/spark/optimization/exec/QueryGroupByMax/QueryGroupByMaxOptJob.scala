...
package com.spark.optimization.exec.QueryGroupByMax

import com.spark.optimization.exec.AbstractJob

/** QueryGroupByCount */

object QueryGroupByMaxOptJob extends AbstractJob {
  ...
  override val query: String =
    """
      |Select table1.topic, max(table1.file_no) FROM enron_data as table1 join enron_data table2
